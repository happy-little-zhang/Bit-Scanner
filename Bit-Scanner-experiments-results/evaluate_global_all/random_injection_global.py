...
if __name__ == "__main__":
    ...
    # csv_file = open('../dataset_global_all/global_random_injection.csv')  # 打开文件
    csv_file = open('../dataset_global_all_1/global_random_injection.csv')  # 打开文件
    ...
    #       plt.plot(x_injection_num, y_recall[i] * 100, linestyle=line_style[i], color=plot_color[i], label=plot_label[i])
    ...
    ax1.yaxis.labelpad = -4  # 设置 y 轴标签与 y 轴线之间的距离
    ax1.xaxis.labelpad = 0  # 设置 y 轴标签与 y 轴线之间的距离
    ax1.tick_params(axis='y', which='major', pad=0)  # 设置刻度标签与轴线的距离
